...
/* harmony import */ var _products_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./products.service */ "./apps/api/src/app/products/products.service.ts");
/* harmony import */ var _cache__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../cache */ "./apps/api/src/cache.ts");



const router = Object(express__WEBPACK_IMPORTED_MODULE_0__["Router"])();
router.get('/', Object(_cache__WEBPACK_IMPORTED_MODULE_2__["cache"])(5 * 60, (req) => req.query.search || (req.query.search && req.query.vendor)), (req, res) => {
    setTimeout(() => res.json(_products_service__WEBPACK_IMPORTED_MODULE_1__["ProductsService"].get(req.query)), 2500);
});
// cache all the time
router.get('/:id', Object(_cache__WEBPACK_IMPORTED_MODULE_2__["cache"])(5 * 60), (req, res) => {
    const id = req.params.id;
    const product = _products_service__WEBPACK_IMPORTED_MODULE_1__["ProductsService"].getById(id);
    return product
        ? res.json(product)
        : res.status(404).json();
});
...
/***/ "./apps/api/src/app/products/products.repository.ts":
/*!**********************************************************!*\
  !*** ./apps/api/src/app/products/products.repository.ts ***!
  \**********************************************************/
/*! exports provided: ProductsRepository */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProductsRepository", function() { return ProductsRepository; });
/* harmony import */ var _assets_data_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../assets/data.json */ "./apps/api/src/assets/data.json");
var _assets_data_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../assets/data.json */ "./apps/api/src/assets/data.json", 1);
...
class ProductsRepository {
    ...
    static get({ vendor, search }) {
        let productsResponse = _assets_data_json__WEBPACK_IMPORTED_MODULE_0__["products"];
        if (vendor) {
    ...
    static getById(id) {
        ...
        return _assets_data_json__WEBPACK_IMPORTED_MODULE_0__["products"].find(product => product.id === id);
    }
}
...
/* harmony import */ var _products_repository__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./products.repository */ "./apps/api/src/app/products/products.repository.ts");

class ProductsService {
    static get(query) {
        return _products_repository__WEBPACK_IMPORTED_MODULE_0__["ProductsRepository"].get(query);
    }
    static getById(id) {
        return _products_repository__WEBPACK_IMPORTED_MODULE_0__["ProductsRepository"].getById(id);
    }
}
...
/***/ "./apps/api/src/app/promotions/promotions.controller.ts":
/*!**************************************************************!*\
  !*** ./apps/api/src/app/promotions/promotions.controller.ts ***!
  \**************************************************************/
/*! exports provided: default */
...
/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ "express");
/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _promotions_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./promotions.service */ "./apps/api/src/app/promotions/promotions.service.ts");


const router = Object(express__WEBPACK_IMPORTED_MODULE_0__["Router"])();
router.get('/', (req, res) => {
    res.json(_promotions_service__WEBPACK_IMPORTED_MODULE_1__["PromotionsService"].get());
});
router.get('/:id', (req, res) => {
    const id = req.params.id;
    res.json(_promotions_service__WEBPACK_IMPORTED_MODULE_1__["PromotionsService"].getById(id));
});
/* harmony default export */ __webpack_exports__["default"] = (router);
...
/***/ "./apps/api/src/app/promotions/promotions.repository.ts":
/*!**************************************************************!*\
  !*** ./apps/api/src/app/promotions/promotions.repository.ts ***!
  \**************************************************************/
/*! exports provided: PromotionsRepository */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PromotionsRepository", function() { return PromotionsRepository; });
/* harmony import */ var _assets_data_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../assets/data.json */ "./apps/api/src/assets/data.json");
var _assets_data_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../assets/data.json */ "./apps/api/src/assets/data.json", 1);
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
...
class PromotionsRepository {
    static get() {
        return [_assets_data_json__WEBPACK_IMPORTED_MODULE_0__["promotion"]].filter(prom => !prom.hide); // only enabled promos
    }
    static getById(id) {
        // find by id and return
        // currently only 1 promotion
        return _assets_data_json__WEBPACK_IMPORTED_MODULE_0__["promotion"];
    }
}
...
/***/ "./apps/api/src/app/promotions/promotions.service.ts":
/*!***********************************************************!*\
  !*** ./apps/api/src/app/promotions/promotions.service.ts ***!
  \***********************************************************/
...
/* harmony import */ var _promotions_repository__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./promotions.repository */ "./apps/api/src/app/promotions/promotions.repository.ts");

class PromotionsService {
    static get() {
        return _promotions_repository__WEBPACK_IMPORTED_MODULE_0__["PromotionsRepository"].get();
    }
    static getById(id) {
        return _promotions_repository__WEBPACK_IMPORTED_MODULE_0__["PromotionsRepository"].getById(id);
    }
}
...
/***/ "./apps/api/src/app/vendors/vendors.controller.ts":
/*!********************************************************!*\
  !*** ./apps/api/src/app/vendors/vendors.controller.ts ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ "express");
/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _vendors_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendors.service */ "./apps/api/src/app/vendors/vendors.service.ts");


const router = Object(express__WEBPACK_IMPORTED_MODULE_0__["Router"])();
router.get('/', (req, res) => {
    res.json(_vendors_service__WEBPACK_IMPORTED_MODULE_1__["VendorsService"].get());
});
/* harmony default export */ __webpack_exports__["default"] = (router);
...
/***/ "./apps/api/src/app/vendors/vendors.repository.ts":
/*!********************************************************!*\
  !*** ./apps/api/src/app/vendors/vendors.repository.ts ***!
  \********************************************************/
/*! exports provided: VendorsRepository */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VendorsRepository", function() { return VendorsRepository; });
/* harmony import */ var _assets_data_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../assets/data.json */ "./apps/api/src/assets/data.json");
var _assets_data_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../assets/data.json */ "./apps/api/src/assets/data.json", 1);
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
...
class VendorsRepository {
    static get() {
        return _assets_data_json__WEBPACK_IMPORTED_MODULE_0__["vendors"];
    }
}
...
/***/ "./apps/api/src/app/vendors/vendors.service.ts":
/*!*****************************************************!*\
  !*** ./apps/api/src/app/vendors/vendors.service.ts ***!
  \*****************************************************/
...
/* harmony import */ var _vendors_repository__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vendors.repository */ "./apps/api/src/app/vendors/vendors.repository.ts");

class VendorsService {
    static get() {
        return _vendors_repository__WEBPACK_IMPORTED_MODULE_0__["VendorsRepository"].get();
    }
}
...
/* harmony import */ var _app_products_products_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./app/products/products.controller */ "./apps/api/src/app/products/products.controller.ts");
/* harmony import */ var _app_promotions_promotions_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/promotions/promotions.controller */ "./apps/api/src/app/promotions/promotions.controller.ts");
/* harmony import */ var _app_vendors_vendors_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./app/vendors/vendors.controller */ "./apps/api/src/app/vendors/vendors.controller.ts");
...
app.use('/api/products', _app_products_products_controller__WEBPACK_IMPORTED_MODULE_2__["default"]);
app.use('/api/promotions', _app_promotions_promotions_controller__WEBPACK_IMPORTED_MODULE_3__["default"]);
app.use('/api/vendors', _app_vendors_vendors_controller__WEBPACK_IMPORTED_MODULE_4__["default"]);
app.get('*', (req, res) => {
...
module.exports = __webpack_require__(/*! C:\Users\Andrii_Shupta\WebstormProjects\product-viewer\apps\api\src\main.ts */"./apps/api/src/main.ts");
